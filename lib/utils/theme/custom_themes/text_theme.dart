...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w400, color: TColors.dark),
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: TColors.dark),
    bodySmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w400, color: TColors.dark.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w400, color: TColors.light),
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: TColors.light),
    bodySmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.w400, color: TColors.light.withOpacity(0.5)),
